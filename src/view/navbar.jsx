            ...
            <React.Fragment>
                <div className="link">
                    ...
                    <div className="pages">
                        ...
                        <Link to={"/next"} style={{ margin: "0px 0px 0px 50px" }}><p>Next</p></Link>
                    </div>
                    <div className="containerbtn">
                        <div className="btn">
                            ...
                            <button>
                                ...
                                <Link to={"/category"} style={{ margin: "0px 0px 0px 0px", color: "black", fontSize: "10px" }}> <img src={bookimgcat} alt="" />Books</Link>
                            </button>
                            <button>

                                <Link to={"/category2"} style={{ margin: "0px 0px 0px 0px", color: "black", fontSize: "10px" }}> <img src={imgtvcat1} alt="" />Televisions</Link>

                            </button>
                            <button>

                                <Link to={"/category3"} style={{ margin: "0px 0px 0px 0px", color: "black", fontSize: "10px" }}><img src={imgwatchcat2} alt="" />Smart Watches</Link>

                            </button>
                            <button>

                                <Link to={"/category4"} style={{ margin: "0px 0px 0px 0px", color: "black", fontSize: "10px" }}> <img src={aircimgcat3} alt="" />Air Conditioners</Link>
                            </button>
                        </div>
                    </div>
